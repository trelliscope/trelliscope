...
export type MetaType = 'panel' | 'string' | 'number' | 'factor' | 'date' | 'datetime' | 'href' | 'geo' | 'graph';
...
export interface IPanelMeta extends IMeta {
  paneltype: PanelType;
  // format?: PanelFormat;
  aspect: number,
  source: IPanelSource,
...
export interface IDisplay {
  ...
  tags: string[];
  keycols: string[];
  keysig: string; // TODO: get rid of this
  metas: IMeta[];
  inputs: IInputs | null;
  state: IDisplayState;
  views: IView[];
