...
This repository contains a rewrite of the trelliscopejs R package, now simply called trelliscope.
...
This creates a quick Trelliscope grouped by country and continent but it lacks customization in the naming and layout as well as any additional metadata for sorting and filtering. We will show how you can expand on this code for more customization in the sections below.
